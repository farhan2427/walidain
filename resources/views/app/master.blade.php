...
<head>
    ...
    <title>Aplikasi Kas Masjid Al-Walidain</title>
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('gambar/sistem/logo.jpg')}}">
...
<body>
            ...
            <div class="brand-logo">
                <a href="{{ url('/home') }}">
                    ...
                    <span class="brand-title">
                        ...
                        <span class="text-white ml-2"><b>AKMAL</b></span>
                    </span>
                </a>
            </div>
        </div>
    ...
    <div class="nk-sidebar">           
        ...
        <div class="p-3 profil_admin">
            <div class="media align-items-center mb-1 mt-3">
               @if(Auth::user()->foto == "")
               <img class="mr-2" src="{{ asset('gambar/sistem/user.png')}}" height="60" width="40" alt="">
               @else
               <img class="mr-2" src="{{ asset('gambar/user/'.Auth::user()->foto) }}" height="60" width="40">
               @endif
            ...
            <ul class="metismenu" id="menu">
                ...
                <li>
                    <a href="{{ route('home') }}" aria-expanded="false">
                        <i class="icon-home menu-icon mr-3"></i><span class="nav-text">Dashboard</span>
                    </a>
                </li>
    ...
    <div class="footer">
        <div class="copyright">
        <p>Copyright &copy; Aplikasi Kas Masjid Al-Walidain by <a href="https://www.instagram.com/mfarhan2427" target="_blank">mfarhan2427</a> {{ date('Y') }}</p>
        </div>
    </div>
</div>
