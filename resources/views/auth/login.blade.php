...
<head>
    ...
    <link rel="icon" type="image/png" href="{{ asset('gambar/sistem/logo.jpg') }}">
                    ...
                    <div class="card login-form mb-0">
                        <div class="card-body pt-5 pb-5">
                            ...
                            <div class="text-center mb-5">
                                <img src="{{ asset('gambar/sistem/logo.png')}}" alt="" style="height: 150px"> 
                                <h3 class=" mt-2"><b>AKMAL</b></h3>
                                <h4 class="mt-1">Aplikasi Kas Masjid Al-Walidain</h4>
                            </div>
